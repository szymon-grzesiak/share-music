...
<button
  class="border text-white border-transparent hover:border-gray-300 focus:border-gray-300 focus:outline-none flex items-center gap-1 text-md font-bold px-3 py-2 rounded hover:shadow-sm"
>
  {{ $slot }}
  @if ($icon)
